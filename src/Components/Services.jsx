...
const Services = () => {
  ...
  return (
    <div className={style.servicesContainer}>
        <h1 className='commonHeading'>Services</h1>
        <p className='commonPara'>Comprehensive business services designed to support growth <br /> and enhance your competitive edge.</p>
